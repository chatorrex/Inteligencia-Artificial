...
pygame.display.set_caption("Modo Árbol de Decisión")
...
def cargar_y_entrenar():
    ...
    with open(ruta_csv, mode='r') as archivo:
        ...
        for fila in lector:
            try:
                ...
                if s_flag == 1: y.append(1) # Salto
                elif a_flag == 1: y.append(2) # Agachado
                else: y.append(0) # Nada
    ...
    modelo = DecisionTreeClassifier(max_depth=8, class_weight='balanced', random_state=42)
    modelo.fit(X, y)
